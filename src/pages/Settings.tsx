  ...
  return (
    <div className="flex h-screen items-start overflow-y-auto py-8 pl-28">
      <div className="mx-auto w-full max-w-2xl px-8">
        <div className="mb-8">
          <h1 className="bg-linear-to-r from-gray-900 to-gray-700 bg-clip-text text-3xl font-bold text-transparent dark:from-gray-100 dark:to-gray-300">
            Settings
          </h1>
        ...
        <div className="space-y-6">
          <div className="overflow-hidden rounded-3xl bg-white/80 shadow-[0_10px_30px_-5px_rgba(0,0,0,0.1)] ring-1 ring-zinc-950/10 backdrop-blur-xl dark:bg-gray-800/80 dark:ring-white/10">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p
                          className={`text-xs ${theme === mode ? 'text-white/80' : 'text-gray-500 dark:text-gray-400'}`}
                        >
